...
<title>Lua Learner – Mobile Friendly</title>
...
<div id="mobileMenuBtn" onclick="toggleLessons()">📚 LESSONS</div>

<div id="mobileLessons"></div>

<div id="content">
    <div id="xpBox">
        <div id="xpText">Level 1 • 0 XP</div>
...
function updateXP() {
    document.getElementById("xpText").innerText = `Level ${level} • ${xp} XP`;
...
function runCode() {
    ...
    try {
        ...
        output.innerText = "✔ Code ran! Check console.";
        addXP(10);
    } catch(e) {
        output.innerText = "❌ " + e;
    }
